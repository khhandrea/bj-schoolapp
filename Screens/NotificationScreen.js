                ...
                <ScrollView showsVerticalScrollIndicator={false} overScrollMode='never' style={{ flex: 1 }}>
                    {this.state.cardData.map((info, index) =>
                        <View key={index} style={{ width: WIDTH }}>
                            <View style={{ width: '100%', minHeight: 40, flexDirection: 'row', alignItems: 'center', borderBottomColor: '#dbdbdb', borderBottomWidth: 0.5, borderTopColor: '#dbdbdb', borderTopWidth: 0.5, }}>
